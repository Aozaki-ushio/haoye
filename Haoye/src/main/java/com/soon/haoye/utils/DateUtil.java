...
public class DateUtil
{
	...
	public final static String DATEFORMART_DEFAULT = "yyyy-MM-dd HH:mm:ss";
    public final static String WEB_FORMATOR_YMDHM  = "yyyy-MM-dd HH:mm";
    public final static String WEB_FORMATOR_MD  = "MM-dd";
    public final static String WEB_FORMATOR_ymd  = "yyyy-MM-dd ";

    public final static String WEB_FORMATOR_YMD  = "yyyy年MM月dd日";
    ...
    public static Date dateTimeString2Date(String date_str,String date_format) {
    	try {
    		return  new SimpleDateFormat(date_format).parse(date_str);
